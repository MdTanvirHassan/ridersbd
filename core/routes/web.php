...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::get('product-query', 'ProductController@query')->name('product.query');
        Route::post('/products/approve', 'ProductController@approve')->name('products.approve');
...
Route::post('/submit-form', 'OrderController@product_query')->name('submitForm');
