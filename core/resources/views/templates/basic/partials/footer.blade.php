                    ...
                    <ul class="text-white">
                        ...
                        <li class="">
                            <a class="footer-link" href="https://ridersgroupbd.com/video-gallery/">
                                ...
                                <span class="">Corporate Video</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="#" class="footer-link">
                            ...
                            <ul class="">
                                <li class="">
                                    <a class="footer-link"
                                        ...
                                        <span class="">Apparel & Textile Machinery</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="footer-link"
                            ...
                            <ul class="">
                                <li class="">
                                    <a class="footer-link"
                                        ...
                                        <span class="">Packaging Machines</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="footer-link"
                            ...
                            <div class="">
                                <a class="footer-link" href="https://ridersgroupbd.com/shop/">
                                    <span class="">
                                        ...
                                        <span class="btn btn-sm btn-secondary">View All</span>
                                    </span>
                                </a>
                            </div>
                        </div>
