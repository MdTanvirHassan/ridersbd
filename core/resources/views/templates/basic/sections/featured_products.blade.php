...
<div class="">
        ...
        <div class="container">
            ...
            <div class="">
                <div class="my-4 text-center">
                    <h3 class="text-center">Our New Products</h3>
                                        ...
                                        <div class="product-content">
                                            <div class="product-before-content">
                                                ...
                                                <div class="ratings-area justify-content-between">
                                                    ...
                                                    <span
                                                        class="ml-2 mr-auto">({{ __($item->reviews->count()) }})
                                                    </span> --}}
                                                    <div class="price">
                                                        @if ($discount > 0)
    ...
    <div class="video-gallery background-gray p-3">
        <div class="container">
            ...
            <div class="">
                <div class="my-4 text-center">
                    <h3 class="text-center">Product Video</h3>
                    <div class="d-flex justify-content-center align-items-center">
                        <div style="border-top: 3px solid #000; width: 10%;"></div>
                        <i aria-hidden="true" class="fas fa-star" style="color: #ff6900; margin: 0 10px;"></i>
                        <div style="border-top: 3px solid #000; width: 10%;"></div>
                ...
                <div class="section-header-2">
                    <h3 class="title">@lang('')</h3>
                    <a href="{{ route('products') }}" class="custom-button theme btn-sm">@lang('View All Videos')</a>
                </div>
                ...
                <div class="section-header-2 my-4 text-center" style="align-items: center; justify-content: center;">
                    <button class="custom-button theme btn-sm" id="view-more-btn">@lang('Watch More Videos')</button>
                </div>
            </div>
        </div>
    </div>
