...
<div class="padding-bottom-half padding-top-half oh">
    <div class="container">
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a href="#cat-{{ $f_category->id }}" class="nav-link @if($loop->first) active @endif" data-toggle="tab">{{ __($f_category->name) }}</a>
            </li>
            @endforeach
        </ul>
        <div class="tab-content">
            @foreach ($f_categories as $f_category)
                <div class="tab-pane fade @if($loop->first) show active @endif" id="cat-{{ $f_category->id }}">
                    <div class="m--15">
