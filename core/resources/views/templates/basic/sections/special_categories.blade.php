                ...
                <div class="col-md-7">
                    ...
                    <div class="px-4">
                        ...
                        <p>
                            ...
                            <br />
                        <p class="justify-content text-size" style="text-align: justify; text-justify: inter-word;">
                            products Sourcing, Buy, payment, Lc, Door to Door service.<br />
                ...
                <div class="col-md-5">
                    ...
                    <div class="px-4">
                        <ul style="list-style-type: circle;" class="">
                            ...
                            <li style="list-style-type: circle;" class="text-size">মেশিনের সাথে আপনি ফ্রি ট্রেনিং পাবেন,
                            </li>
                            ...
                            <li style="list-style-type: circle;" class="text-size">মেশিনে আপনি ২ বছর পর্যন্ত ফ্রি
                                সার্ভিসিং পাবেন,</li>
                            <li style="list-style-type: circle;" class="text-size">সার্ভিসিং এ আমাদের লোক যাবে, তাদের TA
                                (ট্রাভেলিং ভাড়া) দিতে হবে।</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            @foreach ($special_categories as $item)
                <div class="col-md-3 col-sm-6">
                    <a href="{{ route('products.category', ['id' => $item->id, 'slug' => slug($item->name)]) }}"
                        class="d-block text-center bg-white mx-1 my-2 p-1 py-3 align-items-center justify-content-center img-hover"
                        ...
                        <span class="line-limitation- text-dark"
                            style="font-size: 18px; font-weight: bold;">{{ __($item->name) }}</span>
                    </a>
                </div>
            @endforeach
        </div>
