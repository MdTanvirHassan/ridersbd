                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <select class="form-control select2-basic" name="brand_id" required>
                                ...
                                <option selected value="{{@$brand->id}}" {{ isset($product)?($brand->id==$product->brand_id?'selected':''):''}}>
                                    {{ __($brand->name) }}
                                </option>
                                @endforeach
                            </select>
            ...
            <div class="card p-2 my-3">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <textarea rows="5" class="form-control nicEdit" name="summary">{{ $product->summary??'' }}</textarea>
                        </div>
                    </div>
